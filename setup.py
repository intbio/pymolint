...
setup(
    ...
    description='A python package to characterise molecular interactions at atomic level in PDB structures and MD simulations',
    long_description=long_description,

    # The project URL.
    url='https://github.com/intbio/pymolint',
